...
type OperationUI = IOperationDTO & {
  isNew?: boolean;
};

export default defineComponent({
  name: 'DirectoryOperation',
  mixins: [dictMixis<OperationUI>()],
  setup() {
    return {
      storeActoinUpsertRow: 'operationState/upsert',
      storeActoinDeleteRow: 'operationState/delete',
      storeActionGetLazyRows: 'operationState/getLazy',
    };
  },
  data() {
    return {
      rows: [] as OperationUI[],
      editingRows: {} as Record<string, OperationUI>,
      selectionsRowData: [] as OperationUI[],
