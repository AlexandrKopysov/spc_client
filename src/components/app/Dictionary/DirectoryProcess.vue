...
type ProcessUI = IProcessDTO & {
  isNew?: boolean;
};

export default defineComponent({
  name: 'DirectoryProcess',
  mixins: [dictMixis<ProcessUI>()],
  setup() {
    return {
      storeActoinUpsertRow: 'processState/upsert',
      storeActoinDeleteRow: 'processState/delete',
      storeActionGetLazyRows: 'processState/getLazy',
    };
  },
  data() {
    return {
      rows: [] as ProcessUI[],
      editingRows: {} as Record<string, ProcessUI>,
      selectionsRowData: [] as ProcessUI[],
